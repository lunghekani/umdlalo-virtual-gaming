...
<style>
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed page-loading">
		...
		<div class="wrapper " style="padding-top: 50px">
				<!--begin::Content-->
						...
						<!--begin::Subheader-->
						<div class="header header-fixed py-2 py-lg-4 " id="kt_subheader">
	...
	<!--JQUERY-->
		...
		<script src="/Pages/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js?v=7.0.5"></script>
		<script src="//maps.google.com/maps/api/js?key=AIzaSyBTGnKT7dt597vo9QgeQ7BFhvSRP4eiMSM?v=7.0.5"></script>
		<script src="/Pages/assets/plugins/custom/gmaps/gmaps.js?v=7.0.5"></script>
		<!--end::Page Vendors-->
