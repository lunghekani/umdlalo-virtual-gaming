<%@ Page Title="" Language="C#" MasterPageFile="~/Student.Master" AutoEventWireup="true" CodeBehind="student-project-list.aspx.cs" Inherits="UmdlaloVirtualGaming.Pages.student.student_project_list" %>
											...
											<div class="card-body">
												...
												<div class="d-flex align-items-center">
													...
													<div class="flex-shrink-0 mr-4 symbol symbol-65 symbol-circle">
														<img src="/Pages/assets/media/project-logos/3.png" alt="image">
													</div>
													<!--end::Pic-->
													<!--begin::Info-->
													<div class="d-flex flex-column mr-auto">
														<!--begin: Title-->
														<a href="#" class="card-title text-hover-primary font-weight-bolder font-size-h5 text-dark mb-1" id="lblProjectName" runat="server">Nexa - Next generation SAAS</a>
                                                        <!--end::Title-->
													</div>
													<!--end::Info-->
													<%--<!--begin::Toolbar-->
												...
												<div class="d-flex flex-wrap mt-14">
													<div class="mr-12 d-flex flex-column mb-7">
														<span class="d-block font-weight-bold mb-4">Created Date</span>
														<span class="btn btn-light-primary btn-sm font-weight-bold btn-upper btn-text" id="lblProjectDate" runat="server">14 Jan, 16</span>
													</div>
												...
												<div class="d-flex flex-wrap">
                                                    ...
                                                    <div class="mr-12 d-flex flex-column mb-7">
                                                        ...
                                                        <span class="font-weight-bolder font-size-h5 pt-1">
                                                            <span class="font-weight-bold text-dark-50" id="lblJS" runat="server"></span>439,500</span>
                                                    </div>
													<!--end::Item-->
												</div>
												<!--end::Blog-->
											...
											<div class="card-footer d-flex align-items-center">
												<div class="d-flex">
													<div class="d-flex align-items-center mr-7">
														...
														<a href="#" class="font-weight-bolder text-primary ml-2" id="lblProjectLikes" runat="server">72 Tasks</a>
													</div>
													<div class="d-flex align-items-center mr-7">
														<span class="svg-icon svg-icon-gray-500">
														...
														<a href="#" class="font-weight-bolder text-primary ml-2" id="lblProjectComments" runat="server">648 Comments</a>
													</div>
												</div>
											...
											<div class="card-footer d-flex align-items-sm-center flex-wrap flex-column flex-sm-row">
												<div class="d-flex">
													...
													<div class="d-flex mr-7">
														...
														<a href="#" class="font-weight-bolder text-primary ml-2" id="lblProjectViews" runat="server">648 Views</a>
													</div>
												</div>
												<button type="button" class="btn btn-primary btn-sm text-uppercase font-weight-bolder mt-5 mt-sm-0 mr-auto mr-sm-0 ml-sm-auto">Views</button>
											</div>
											<!--end::Footer-->
										</div>
										<!--end::Card-->
