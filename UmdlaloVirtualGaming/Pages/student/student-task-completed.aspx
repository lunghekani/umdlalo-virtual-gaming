											...
											<div class="card-body">
												...
												<div class="d-flex align-items-center">
													...
													<div class="d-flex flex-column mr-auto">
														<!--begin: Title-->
														<div class="d-flex flex-column mr-auto">
															<a href="#" class="text-dark text-hover-primary font-size-h4 font-weight-bolder mb-1">Hangman</a>
															<span class="text-muted font-weight-bold">A player thinks of a word, phrase or sentence and the other tries to guess its</span>
														</div>
														<!--end::Title-->
													</div>
													<!--end::Info-->
												...
												<!--end::Info-->
												<!--begin::Description-->
												<div class="mb-10 mt-5 font-weight-bold"> A player thinks of a word, phrase or sentence and the other tries to guess it by suggesting letters within a certain number of guesses..</div>
												<!--end::Description-->
												<!--begin::Data-->
												...
												<div class="d-flex mb-5 align-items-cente">
													<span class="d-block font-weight-bold mr-5">Mark</span>
