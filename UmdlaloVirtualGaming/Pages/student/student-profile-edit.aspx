<%@ Page Title="" Language="C#" MasterPageFile="~/Student.Master" AutoEventWireup="true" CodeBehind="student-profile-edit.aspx.cs" Inherits="UmdlaloVirtualGaming.Pages.student.student_profile_edit" %>
                    ...
                    <form class="form">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <asp:TextBox id="txtName" CssClass="form-control form-control-lg form-control-solid" runat="server"></asp:TextBox>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <asp:TextBox id="txtLastName" CssClass="form-control form-control-lg form-control-solid" runat="server"></asp:TextBox>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <asp:TextBox id="txtNickName" CssClass="form-control form-control-lg form-control-solid" runat="server"></asp:TextBox>
                                
                                <span class="form-text text-muted">This is a username that will be displayed on the leaderboard</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <div class="input-group input-group-lg input-group-solid">
                                    ...
                                    <asp:TextBox id="txtEmail" CssClass="form-control form-control-lg form-control-solid" runat="server" ></asp:TextBox>
