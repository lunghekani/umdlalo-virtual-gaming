...
{
    public partial class student_comment_chat : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                var name = Request.Params["user_name"];       // current username
                var user_id = Request.Params["user_id"];      // user-id
                var course_id = Request.Params["course_id"];  //project id
