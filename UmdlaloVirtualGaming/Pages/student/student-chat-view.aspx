<%@ Page Title="" Language="C#" MasterPageFile="~/Student.Master" AutoEventWireup="true" CodeBehind="student-chat-view.aspx.cs" Inherits="UmdlaloVirtualGaming.Pages.student.student_chat_view" %>
												...
												<div class="mt-7 scroll scroll-pull ps ps--active-y" style="height: 673px; overflow: hidden;">
													<!--begin:User-->
														<% foreach (var item in course_list) { %>
															<div class="d-flex align-items-center justify-content-between mb-5  private_chat_user" style="cursor:pointer"  data-course="<%=item.Value %>"  data-user-id="<%=user_id %>"   data-user-name="<%=user_name %>" data-id="<%=item.Key %>">
																...
																<span class="text-muted font-weight-bold font-size-sm "  id="private_chat_time<%=item.Key %>"></span>
																<span class="label label-sm label-light-success " id="private_chat_notification<%=item.Key %>"  style="opacity:0;">0</span>
																</div>
															</div>
										...
										<div class="card card-custom">
											...
											<div class="card-header align-items-center px-4 py-3">
												...
												<div class="text-center flex-grow-1">
													<div class="text-dark-75 font-weight-bold font-size-h5 private_chat_header"></div>
													<div>
											...
											<div class="card-body">
												...
												<div class="scroll scroll-pull ps ps--active-y" data-mobile-height="350" style="height: 525px; overflow: hidden;">
													<!--begin::Messages-->
													<div class="messages  private_chat_messages_box">
														
													
													</div>
													<!--end::Messages-->
												<div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 525px; right: -2px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 261px;"></div></div></div>
												<!--end::Scroll-->
											</div>
											<!--end::Body-->
											<!--begin::Footer-->
											<div class="card-footer align-items-center">
												<!--begin::Compose-->
												<textarea class="form-control border-0 p-0  private_chat_textarea" rows="2" placeholder="Type a message"></textarea>
												<div class="d-flex align-items-center justify-content-between mt-5">
													...
													<div>
														<button type="button" class="btn btn-primary btn-md text-uppercase font-weight-bold chat-send py-2 px-6 private_chat_submit_button">Send</button>
													</div>
												</div>
												<!--begin::Compose-->
											</div>
