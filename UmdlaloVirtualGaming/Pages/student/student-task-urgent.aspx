											...
											<div class="card-body">
												...
												<div class="d-flex align-items-center">
													...
													<div class="d-flex flex-column mr-auto">
														<!--begin: Title-->
														<div class="d-flex flex-column mr-auto">
															<a href="#" class="text-dark text-hover-primary font-size-h4 font-weight-bolder mb-1">Kgathi </a>
															<span class="text-muted font-weight-bold">A game played by young girls and boys</span>
														</div>
														<!--end::Title-->
													</div>
													<!--end::Info-->
												...
												<!--end::Info-->
												<!--begin::Description-->
												<div class="mb-10 mt-5 font-weight-bold">A game played by young girls and boys  whereby they skip rope singing song for enjoyment.</div>
												<!--end::Description-->
												<!--begin::Data-->
