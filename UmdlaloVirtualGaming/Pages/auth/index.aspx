					...
					<div class="login-form text-center text-white p-7 position-relative overflow-hidden">
						...
						<div class="login-signup">
							...
							<form class="form text-center" id="kt_login_signup_form" runat="server" >
								...
								<div class="form-group">
									<input class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8" id="txtCPassword"type="password" runat="server" placeholder="Confirm Password" name="cpassword" />
								</div>
								...
								<div class="form-group">
									<button id="kt_login_signup_submit" class="btn btn-pill btn-primary opacity-90 px-15 py-3 m-2" runat="server" onserverclick="kt_login_signin_submit_ServerClick"  >Sign Up</button>
