<%@ Page Title="" Language="C#" MasterPageFile="~/Lecturer.Master" AutoEventWireup="true" CodeBehind="content-view.aspx.cs" Inherits="UmdlaloVirtualGaming.Pages.lecturer.content_view" %>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-flex flex-column flex-grow-1">
                            <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">Introduction</a>
                            <div class="d-flex">
            ...
            <div class="card card-custom gutter-b">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <!--begin::Info-->
                        <div class="d-flex flex-column flex-grow-1">
                            <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">Structure card</a>
                            <div class="d-flex">
                                <div class="d-flex align-items-center pr-5">
                                    <span class="svg-icon svg-icon-md svg-icon-primary pr-1">
                                        <!--begin::Svg Icon | path:assets/media/svg/icons/Home/Clock.svg-->
