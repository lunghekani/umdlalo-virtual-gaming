...
<%@ Page Title="" Language="C#" MasterPageFile="~/Lecturer.Master" AutoEventWireup="true"  CodeBehind="lecture-private-chat.aspx.cs" Inherits="UmdlaloVirtualGaming.Pages.lecturer.lecture_private_chat"  %>
													...
													<!--begin:User-->
														<% foreach (var item in course_list) { %>
															<div class="d-flex align-items-center justify-content-between mb-5  private_chat_user" style="cursor:pointer"  data-course="<%=item.course_name %>"  data-user-id="<%=item.user_id %>"   data-user-name="<%=item.course_name %>" data-id="<%=item.course_id %>">
																...
																<span class="text-muted font-weight-bold font-size-sm "  id="private_chat_time<%=item.course_id %>"></span>
																<span class="label label-sm label-light-success " id="private_chat_notification<%=item.course_id %>" style="opacity:0;">0</span>
																</div>
															</div>
