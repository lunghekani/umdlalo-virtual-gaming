...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="card card-custom">
        ...
        <div class="card-body">
            ...
            <!--end: Search Form-->
            <!--begin: Datatable-->
            <asp:GridView runat="server" ID="gvCourses" CssClass="datatable datatable-bordered datatable-head-custom datatable-default datatable-primary datatable-loaded"></asp:GridView>
