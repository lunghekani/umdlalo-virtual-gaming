                ...
                <div class="d-flex justify-content-between flex-column h-100">
                    ...
                    <div class="h-100">
                        ...
                        <div class="d-flex flex-column flex-center">
                            ...
                            <!--end::Image-->
                            <!--begin::Title-->
                            <a href="#" class="card-title font-weight-bolder text-dark-75 text-hover-primary font-size-h4 m-0 pt-7 pb-1">Enactus</a>
                            <!--end::Title-->
                            <!--begin::Text-->
                            <div class="font-weight-bold text-dark-50 font-size-sm pb-7">University of johannesburg</div>
                            <!--end::Text-->
                        </div>
                        <!--end::Header-->
                        <!--begin::Body-->
                        <div class="pt-1">
                            ...
                            <div class="d-flex align-items-center pb-9">
                                ...
                                <div class="d-flex flex-column flex-grow-1">
                                    <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">Grades</a>
                                    <span class="text-muted font-weight-bold"></span>
                                </div>
                                <!--end::Text-->
                                <!--begin::label-->
                                <span class="font-weight-bolder label label-xl label-light-success label-inline px-3 py-5 min-w-45px"></span>
                                <!--end::label-->
                            </div>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <div class="d-flex align-items-center pb-9">
                                ...
                                <!--end::Text-->
                                <!--begin::label-->
                                <span class="font-weight-bolder label label-xl label-light-danger label-inline px-3 py-5 min-w-45px"></span>
                                <!--end::label-->
                            </div>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <div class="d-flex align-items-center pb-9">
                                ...
                                <!--end::Text-->
                                <!--begin::label-->
                                <span class="font-weight-bolder label label-xl label-light-primary label-inline py-5 min-w-45px"></span>
                                <!--end::label-->
                            </div>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <div class="d-flex align-items-center pb-9">
                                ...
                                <!--end::Text-->
                                <!--begin::label-->
                                <span class="font-weight-bolder label label-xl label-light-info label-inline px-3 py-5 min-w-45px"></span>
                                <!--end::label-->
                            </div>
                            <!--end::Item-->
                        </div>
