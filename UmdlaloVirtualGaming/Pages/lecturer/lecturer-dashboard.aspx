	...
	<div class="col-lg-6 col-xxl-4 order-1 order-xxl-1">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column flex-grow-1">
                        <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">Educational vidoes</a>
                        <div class="d-flex">
                            <div class="d-flex align-items-center pr-5">
                                <span class="svg-icon svg-icon-md svg-icon-primary pr-1">
                                    <!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Home/Clock.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24"></rect>
                ...
                <div class="pt-3">
                    <!--begin::Text-->
                    <p class="text-dark-75 font-size-lg font-weight-normal pt-5 mb-7">Something new everyday</p>
                    <!--end::Text-->
                    <!--begin::Video-->
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item rounded" src="https://www.youtube.com/watch?v=HIj8wU_rGIU" allowfullscreen="allowfullscreen"></iframe>
                    </div>
                    <!--end::Video-->
                    <!--begin::Action-->
                ...
                <form class="position-relative">
                    <textarea id="kt_forms_widget_9_input" class="form-control border-0 p-0 pr-10 resize-none" rows="1" placeholder="Any Questions?" style="overflow: hidden; word-wrap: break-word; height: 19px;"></textarea>
