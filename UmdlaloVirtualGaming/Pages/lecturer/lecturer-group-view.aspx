<%@ Page Title="" Language="C#" MasterPageFile="~/Lecturer.Master" AutoEventWireup="true" CodeBehind="lecturer-group-view.aspx.cs" Inherits="UmdlaloVirtualGaming.Pages.lecturer.lecturer_group_view" %>
												...
												<div class="mt-7 scroll scroll-pull ps ps--active-y" style="height: 673px; overflow: hidden;">
													<!--begin:User-->
														<% foreach (var item in course_list) { %>
															<div class="d-flex align-items-center justify-content-between mb-5  group_chat_user" style="cursor:pointer"  data-course="<%=item.course_name %>"  data-user-id="<%=user_id %>"   data-user-name="<%=user_name %>" data-id="<%=item.course_id %>">
